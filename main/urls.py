...
urlpatterns = [
    ...
    url(r'^proprietaire/(?P<proprietaire_id>[0-9]+)/$', proprietaire.proprietaire, name='proprietaire'),
    ...
    url(r'^batiment/fraismaintenance/prepare/update/([0-9]+)/$', frais.prepare_update_from_batiment,
        name='fraismaintenance-edit-from-batiment'),
    url(r'^location/fraismaintenance/prepare/update/([0-9]+)/$', frais.prepare_update_from_location,
        name='fraismaintenance-edit-from-location'),
    url(r'^dashboard/fraismaintenance/prepare/update/([0-9]+)/$', frais.prepare_update_from_dashboard,
        name='fraismaintenance-edit-from-dashboard'),
    url(r'^frais/list/fraismaintenance/prepare/update/([0-9]+)/$', frais.prepare_update_from_list,
        name='fraismaintenance-edit-from-list'),

    url(r'^batiment/fraismaintenance/delete/([0-9]+)/$', frais.delete_frais_from_batiment,
        name='fraismaintenance-delete-from-batiment'),
    url(r'^location/fraismaintenance/delete/([0-9]+)/$', frais.delete_frais_from_location,
        name='fraismaintenance-delete-from-location'),
    url(r'^frais/liste/fraismaintenance/delete/([0-9]+)/$', frais.delete_frais_from_list,
        name='fraismaintenance-delete-from-list'),
    # url(r'^proprietaire/create/$', views.ProprietaireCreate.as_view(), name='proprietaire-create'),
    # url(r'^proprietaire/createb/(?P<pk>[0-9]+)/$', views.ProprietaireCreateForBatiment.as_view(),
    # name='proprietaire-create-batiment'),
    ...
    # url(r'^contratgestion/update/(?P<pk>[0-9]+)/$', views.ContratGestionUpdate.as_view(),
    # name='contratgestion-update'),
