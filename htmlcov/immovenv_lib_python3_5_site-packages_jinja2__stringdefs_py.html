...
<head>
    ...
    <title>Coverage for immovenv/lib/python3.5/site-packages/jinja2/_stringdefs.py: 10.42%</title>
...
<div id="header">
    <div class="content">
        <h1>Coverage for <b>immovenv/lib/python3.5/site-packages/jinja2/_stringdefs.py</b> :
            <span class="pc_cov">10.42%</span>
        </h1>
...
<p id="t22" class="stm par run hide_run"><span class="annotate short">22&#x202F;&#x219B;&#x202F;23</span><span class="annotate long">line 22 didn't jump to line 23, because the condition on line 22 was never true</span><span class="key">if</span> <span class="nam">__name__</span> <span class="op">==</span> <span class="str">'__main__'</span><span class="op">:</span><span class="strut">&nbsp;</span></p>
